                  ...
                  >
                    <div className="flex justify-start items-center gap-4">
                      ...
                      <Link
                        ...
                        className="p-[6px] bg-sky-500 rounded-lg text-white transition-all hover:shadow-lg hover:shadow-yellow-500/50"
                      >
                        {" "}
                        <LuImageMinus />{" "}
                      </Link>

                      <Link className="p-[6px] bg-green-500 rounded-lg text-white transition-all hover:shadow-lg hover:shadow-green-500/50">
                        {" "}
                        <FaEye />{" "}
                      </Link>
                      <Link className="p-[6px] bg-red-500 rounded-lg text-white transition-all hover:shadow-lg hover:shadow-red-500/50">
                        {" "}
                        <FaTrash />{" "}
                      </Link>
                    </div>
